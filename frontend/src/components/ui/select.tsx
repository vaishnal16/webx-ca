...
const SelectTrigger = React.forwardRef<
  ...
  SelectTriggerProps
>(({ className, children, error, isLoading, size = 'md', ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      // Base styles
      "flex w-full items-center justify-between rounded-md border bg-background",
    ...
    {...props}
  >
    <span className={cn("flex items-center gap-2", isLoading && "text-muted-foreground")}>
